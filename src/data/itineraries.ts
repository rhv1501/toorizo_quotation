    ...
    days: [
      {
        ...
        activities: [
          "Visit Kodaikanal Lake for boating and cycling",
          "Visit Bryant Park and Coaker's Walk",
          "In the evening, explore the local market near the lake",
          "Overnight stay at Kodaikanal",
        ],
      },
      {
        day: 2,
        title: "Pillar Rocks Route",
        activities: [
          "After breakfast, proceed for sightseeing covering Green Valley View, Pillar Rocks, Guna Caves, and Pine Forest",
          "All places are on the same route, making it smooth and easy to cover",
      ...
      {
        day: 3,
        title: "Berijam Lake Route",
        activities: [
          "After early breakfast, proceed towards forest-side attractions including Berijam Lake, Silent Valley View, and Caps Fly Valley",
          "Enjoy scenic views and peaceful surroundings",
          "Return by afternoon and spend the evening at leisure",
          "Overnight stay at Kodaikanal",
        ],
      },
      {
        day: 4,
        title: "Departure via Waterfalls Route",
        activities: [
          "After breakfast, check out and proceed for departure",
          "Enroute visit Bear Shola Falls, Silver Cascade Falls, and Moir Point (scenic viewpoint on the way)",
          "Continue journey for drop at Madurai/Coimbatore",
        ],
      },
    ],
  },
